...
README는 이 시스템이 **무엇을 하는지**를 설명합니다. 이 문서는 **어떻게 돌아가고
어떻게 운영하는지**를 다룹니다 — 코드를 고치거나 배포할 사람이 읽는 문서입니다.

관련 문서:

- `docs/korea-holdings.md` — 한국 보유종목을 어떤 소스로 알 수 있고 없는지, 그 근거
- `docs/korea-holdings-buildout.md` — 만들어온 이력과, 뒤집힌 판단들
